#!/bin/bash
# bash script to execute the second experiment
...
OUT_ROOT="~/adv-comp-arch/lab1/parsec-3.0/parsec_workspace/outputs/exp2"

L1_FLAGS="-L1c 32 -L1a 8 -L1b 64"
L2_FLAGS=(
"-L2c 512 -L2a 4 -L2b 64"
"-L2c 512 -L2a 8 -L2b 128"
"-L2c 512 -L2a 8 -L2b 256"
"-L2c 1024 -L2a 8 -L2b 64"
"-L2c 1024 -L2a 8 -L2b 128"
"-L2c 1024 -L2a 8 -L2b 256"
"-L2c 1024 -L2a 16 -L2b 64"
"-L2c 1024 -L2a 16 -L2b 128"
"-L2c 1024 -L2a 16 -L2b 256"
"-L2c 2048 -L2a 8 -L2b 64"
"-L2c 2048 -L2a 8 -L2b 128"
"-L2c 2048 -L2a 8 -L2b 256"
)
