...
PIN_TOOL=/home/stefanos/Documents/programming-projects/uni/ntua-advcomparch-lab/lab2/advcomparch-ex2-helpcode/pintool/obj-intel64/cslab_branch_stats.so
...
for BENCH in $@; do
    ...
    base_name=$(basename "$BENCH")
    string_part=$(echo "$base_name" | cut -d '.' -f 2-)

	pinOutFile="$outDir/${BENCH}.cslab_branch_predictors_stats.out"
